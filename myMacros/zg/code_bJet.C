...
//     (Thu Mar  3 16:43:04 2022 by ROOT version6.10/09)
//   from TTree t/ak4PFpatJetsWithBtagging Jet Analysis Tree
//   found on file: /data_CMS/cms/mnguyen//bJet2022/bJetMC/SD/merged_HiForestAOD.root
//////////////////////////////////////////////////////////


//Reset ROOT and connect tree file
   gROOT->Reset();
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data_CMS/cms/mnguyen//bJet2022/bJetMC/SD/merged_HiForestAOD.root");
   if (!f) {
      f = new TFile("/data_CMS/cms/mnguyen//bJet2022/bJetMC/SD/merged_HiForestAOD.root");
   }
    TDirectory * dir = (TDirectory*)f->Get("/data_CMS/cms/mnguyen//bJet2022/bJetMC/SD/merged_HiForestAOD.root:/ak4PFJetAnalyzer");
