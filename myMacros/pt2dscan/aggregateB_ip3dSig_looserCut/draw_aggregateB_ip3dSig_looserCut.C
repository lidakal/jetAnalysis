...
{      
    ...
    if (GSPincl) {
        histfile_reco += "~/rootFiles/aggregateB_ip3dSig_looserCut_reco.root";
        histfile_ref += "~/rootFiles/aggregateB_ip3dSig_looserCut_ref.root";
        histfile_par += "~/rootFiles/aggregateB_ip3dSig_looserCut_par.root";
    } else {
        histfile_reco += "~/rootFiles/aggregateB_ip3dSig_looserCut_noGSP_reco.root";
        histfile_ref += "~/rootFiles/aggregateB_ip3dSig_looserCut_noGSP_ref.root";
        histfile_par += "~/rootFiles/aggregateB_ip3dSig_looserCut_noGSP_par.root";
    }
