...
void draw_pt2dscan_GSP_ratio(char qtype = 'B', bool gspORno = true, bool ktORzg = false, bool dynKt = false)
{          
    ...
    string ytitle = "";
    string title = "";
    string savename = "~/gitRepos/jetAnalysis/myMacros/pt2dscan/plots/ratio/pt2dscan";
