...
void draw_pt2dscan_GSP_charged(char qtype = 'B', bool gspORno = true, bool ktORzg = true, bool dynKt = true)
{           
    ...
    string ytitle = "";
    string title = "";
    string savename = "~/gitRepos/jetAnalysis/myMacros/pt2dscan/chargedPlots/pt2dscan";
