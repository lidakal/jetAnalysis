...
void draw_aggregateB_ip3dSig(bool GSPincl = false)
{      
    ...
    if (GSPincl) {
        histfile_reco += "~/rootFiles/aggregateB_ip3dSig_reco.root";
        histfile_ref += "~/rootFiles/aggregateB_ip3dSig_ref.root";
        histfile_par += "~/rootFiles/aggregateB_ip3dSig_par.root";
    } else {
        histfile_reco += "~/rootFiles/aggregateB_ip3dSig_noGSP_reco.root";
        histfile_ref += "~/rootFiles/aggregateB_ip3dSig_noGSP_ref.root";
        histfile_par += "~/rootFiles/aggregateB_ip3dSig_noGSP_par.root";
    }
    ...
    for (int i = 0; i < npt; i++) {
        ...
        info->AddText("aggregateB_ip3dSig b-jets");
    ...
    string savename_c = "aggregateB_ip3dSig_bjets_ref_vs_reco";
    if (!GSPincl) {
        savename_c += "_noGSP";
    }
