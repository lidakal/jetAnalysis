...
void draw_pt2dscan_GSP_ratio_lateSD(char qtype = 'C', bool gspORno = false, bool ktORzg = true, bool dynKt = false)
{       
    bool lateSD = true;
    
    string histfile_ref = "~/rootFiles/pt2dscan_ref_lateSD.root";
    string histfile_par = "~/rootFiles/pt2dscan_par_lateSD.root";
    ...
    string ytitle = "";
    string title = "";
    string savename = "~/gitRepos/jetAnalysis/myMacros/pt2dscan/lateSDplots/pt2dscan";
