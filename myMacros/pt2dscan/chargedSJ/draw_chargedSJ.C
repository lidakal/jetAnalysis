...
{      
    ...
    if (GSPincl) {
        histfile_ref += "~/rootFiles/chargedSJ_ref.root";
        histfile_par += "~/rootFiles/chargedSJ_par.root";
    } else {
        histfile_ref += "~/rootFiles/chargedSJ_noGSP_ref.root";
        histfile_par += "~/rootFiles/chargedSJ_noGSP_par.root";
    }
    ...
    string savename_c = "chargedSJ_bjets_par_vs_had";
    if (!GSPincl) {
        savename_c += "_noGSP";
    }
