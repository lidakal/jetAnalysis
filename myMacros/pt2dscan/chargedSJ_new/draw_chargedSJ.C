...
{      
    ...
    if (GSPincl) {
        histfile_reco += "~/rootFiles/chargedSJ_new_reco.root";
        histfile_ref += "~/rootFiles/chargedSJ_new_ref.root";
        histfile_par += "~/rootFiles/chargedSJ_new_par.root";
    } else {
        histfile_reco += "~/rootFiles/chargedSJ_new_noGSP_reco.root";
        histfile_ref += "~/rootFiles/chargedSJ_new_noGSP_ref.root";
        histfile_par += "~/rootFiles/chargedSJ_new_noGSP_par.root";
    }
