#include "TreeAnalyzer_chargedSJ_mergedSVtracks_gen_reco.h"
#include "TH3.h"
#include <iostream>
#include <stdlib.h>
...
void plot_chargedSJ_mergedSVtracks_gen_reco(string level = "ref", bool GSPincl = true)
{
    ...
    TreeAnalyzer_chargedSJ_mergedSVtracks_gen_reco TAb;
    
    // Create output file name
    string foutname = "~/rootFiles/chargedSJ_mergedSVtracks_gen_reco";
    if (!GSPincl) {
        foutname += "_noGSP";
    }
