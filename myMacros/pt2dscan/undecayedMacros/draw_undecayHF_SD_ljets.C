...
{      
    ...
    TH3F *h3d_ref = (TH3F *) fin_ref->Get("h_qcd_rgktL")->Clone();
    TH3F *h3d_ref_dynKt = (TH3F *) fin_ref->Get("h_qcd_rgktL_dynKt")->Clone();

    // Load par 3D histogram -- X = rg, Y = zg / kt, Z = pt 
    TFile *fin_par = new TFile(histfile_par.c_str());
    TH3F *h3d_par = (TH3F *) fin_par->Get("h_qcd_rgktL")->Clone();
    ...
    string savename_c = "SD_ljets_par_vs_had";
