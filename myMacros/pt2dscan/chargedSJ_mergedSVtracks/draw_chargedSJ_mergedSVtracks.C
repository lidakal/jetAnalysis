...
{      
    ...
    if (GSPincl) {
        histfile_reco += "~/rootFiles/chargedSJ_mergedSVtracks_reco.root";
        histfile_par += "~/rootFiles/chargedSJ_mergedSVtracks_par.root";
    } else {
        histfile_reco += "~/rootFiles/chargedSJ_mergedSVtracks_noGSP_reco.root";
        histfile_par += "~/rootFiles/chargedSJ_mergedSVtracks_noGSP_par.root";
    }
    ...
    for (int i = 0; i < npt; i++) {
        ...
        info->AddText("chargedSJ_mergedSVtracks b-jets");
    ...
    string savename_c = "chargedSJ_mergedSVtracks_bjets_par_vs_reco";
    if (!GSPincl) {
        savename_c += "_noGSP";
    }
