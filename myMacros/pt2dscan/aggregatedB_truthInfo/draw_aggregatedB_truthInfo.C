...
void draw_aggregatedB_truthInfo(bool GSPincl = true)
{      
    string histfile_reco = "";
    string histfile_par = "";

    if (GSPincl) {
        histfile_reco += "~/rootFiles/aggregatedB_truthInfo_reco.root";
        histfile_par += "~/rootFiles/aggregatedB_truthInfo_par.root";
    } else {
        histfile_reco += "~/rootFiles/aggregatedB_truthInfo_noGSP_reco.root";
        histfile_par += "~/rootFiles/aggregatedB_truthInfo_noGSP_par.root";
    }
    ...
    for (int i = 0; i < npt; i++) {
        ...
        info->AddText("aggregatedB_truthInfo b-jets");
        ...
        // c_ratio : reco/par, reco dynKt/par
    ...
    string savename_c = "aggregatedB_truthInfo_bjets_par_vs_reco";
    if (!GSPincl) {
        savename_c += "_noGSP";
    }
