...
void draw_svtx_perTrack(std::string variable = "svtxdls") 
{
    ...
    std::string hbkg_name = "hbkg_" + variable;
    ...
    std::string y1title = "1/N_{total tracks (not) from B decays} dN_{tracks (not) from B decays}/" + variable;
    ...
    std::string savename = variable + ".png";
