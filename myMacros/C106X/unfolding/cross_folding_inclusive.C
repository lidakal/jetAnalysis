...
void cross_folding_inclusive(TString observable="rg")
{
    ...
    TFile *fin_pythia = new TFile("histos/dijet_aggrTMVA_inclusive_response_full_jer_nom_jec_nom.root");
    TH2D *h_pythia_reco = (TH2D *) fin_pythia->Get("h_training_reco_"+observable+"pt")->Clone("h_pythia_reco");
    TH2D *h_pythia_true = (TH2D *) fin_pythia->Get("h_training_true_"+observable+"pt")->Clone("h_pythia_true");
    TH2D *h_pythia_purity = (TH2D *) fin_pythia->Get("h_training_purity_"+observable+"pt")->Clone("h_pythia_purity");
    TH2D *h_pythia_efficiency = (TH2D *) fin_pythia->Get("h_training_efficiency_"+observable+"pt")->Clone("h_pythia_efficiency");
    RooUnfoldResponse *response_pythia = (RooUnfoldResponse *) fin_pythia->Get("response_" + observable + "pt")->Clone("response_pythia");

    TFile *fin_herwig = new TFile("histos/herwig_dijet_aggrTMVA_inclusive_response_full_jer_nom_jec_nom.root");
    TH2D *h_herwig_reco = (TH2D *) fin_herwig->Get("h_training_reco_"+observable+"pt")->Clone("h_herwig_reco");
    TH2D *h_herwig_true = (TH2D *) fin_herwig->Get("h_training_true_"+observable+"pt")->Clone("h_herwig_true");
    TH2D *h_herwig_purity = (TH2D *) fin_herwig->Get("h_training_purity_"+observable+"pt")->Clone("h_herwig_purity");
    TH2D *h_herwig_efficiency = (TH2D *) fin_herwig->Get("h_training_efficiency_"+observable+"pt")->Clone("h_herwig_efficiency");
    ...
    c_pythia->Draw();
    c_pythia->Print("plots_an/dijet_aggrTMVA_inclusive_xfolding_test_"+observable+".png");
    ...
    c_herwig->Draw();
    c_herwig->Print("plots_an/herwig_dijet_aggrTMVA_inclusive_xfolding_test_"+observable+".png");
