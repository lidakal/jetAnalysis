...
void draw_rgkt_poster()
{
    ...
    hBtag_aggr->GetXaxis()->SetTitle("ln(1/R_{g})");
    ...
    hBtag_noAggr->GetXaxis()->SetTitle("ln(1/R_{g})");
    ...
    TPaveText *info_top_left = new TPaveText(0.9, 3., 2.15, 3.4, "nb ndc");
    ...
    TPaveText *info_top_right = new TPaveText(2.7, 3., 4., 3.4, "nb ndc");
    ...
    TPaveText *info_jets = new TPaveText(2.5, 1., 4., 2.5, "nb ndc");
