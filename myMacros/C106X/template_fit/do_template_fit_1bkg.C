...
void do_template_fit_1bkg()
{
    ...
    TString rootf_out = "histos/qcd_" + sample + "_" + label + "_fitted_parameters_" + label_out + "_1bkg.root";
        ...
        for (Int_t ibin_rg = 1; ibin_rg <= nbins_rg; ibin_rg++) {
            ...
            // if (status == 0) {                       // check on fit status
                ...
                if (make_plots) {
                    ...
                    Double_t int0 = hsig_mB->Integral(1, nbins_mB); // b+bb
