...
void draw_raw_poster()
{
    ...
    // Make decorations
    TPaveText *info_top_left = new TPaveText(-0.4, 0.505, 0.05, 0.525, "nb ndc");
    ...
    TPaveText *info_top_right = new TPaveText(1., 0.505, 1.6, 0.525, "nb ndc");
    ...
    for (size_t i = 0; i < stacks.size(); i++) {
        data_incl_hists[i]->SetMarkerStyle(kFullCircle);
        data_incl_hists[i]->SetMarkerSize(2);
        data_incl_hists[i]->SetMarkerColor(kBlack);
        data_incl_hists[i]->SetLineColor(kBlack);
        ...
        mc_incl_hists[i]->SetMarkerStyle(kFullTriangleDown);
        mc_incl_hists[i]->SetMarkerSize(2);
        mc_incl_hists[i]->SetMarkerColor(mykGreenLight);
        mc_incl_hists[i]->SetLineColor(mykGreenLight);
        ...
        mc_btag_hists[i]->SetMarkerColor(mykRed);
        mc_btag_hists[i]->SetLineColor(mykRed);
