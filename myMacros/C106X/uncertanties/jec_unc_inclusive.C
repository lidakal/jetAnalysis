...
void jec_unc_inclusive(TString observable="rg")
{
     // Setup 
    ...
    TFile *fin_up = new TFile("../unfolding/histos/dijet_aggrTMVA_inclusive_unfolded_histograms_"+observable+"_jer_nom_jec_up.root");
    TH2D *h_up = (TH2D *) fin_up->Get("h_data_unfolded")->Clone("h_up");
    TFile *fin_down = new TFile("../unfolding/histos/dijet_aggrTMVA_inclusive_unfolded_histograms_"+observable+"_jer_nom_jec_down.root");
    ...
    TFile *fout = new TFile("./histos/"+observable+"_jec_unc_inclusive.root", "recreate");
    ...
    for (int ibin_pt = 1; ibin_pt <= nbins_pt; ibin_pt++) {
        ...
        h_unc_up->GetYaxis()->SetTitle("(var-nom)/nom");
        ...
        h_unc_down->GetYaxis()->SetTitle("(var-nom)/nom");
        ...
        TLine *line = new TLine(h_unc_up_rel->GetXaxis()->GetBinLowEdge(ibin_x_min), 0, h_unc_up_rel->GetXaxis()->GetBinUpEdge(ibin_x_max), 0);
