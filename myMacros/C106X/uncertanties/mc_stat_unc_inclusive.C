...
void mc_stat_unc_inclusive(TString observable="rg")
{
    ...
    TString fin_name = "../unfolding/histos/dijet_PF40_aggrTMVA_inclusive_unfolded_histograms_"+observable+"_jer_nom_jec_nom.root";
    ...
    TString fout_name = "./histos/"+observable+"_mc_stat_unc_inclusive.root";
    ...
    for (int ibin_pt = 1; ibin_pt <= nbins_pt; ibin_pt++) {
        ...
        h_nom_1d->GetYaxis()->SetRangeUser(0., 0.012);
        if (observable=="zg") h_nom_1d->GetYaxis()->SetRangeUser(0., 0.06);
        ...
        for (int i=0; i<10; i++) {
            ...
            h_diff_1d->GetYaxis()->SetRangeUser(-0.01, 0.01);
            if (observable=="zg") h_diff_1d->GetYaxis()->SetRangeUser(-0.01, 0.01);
        ...
        jet_info->DrawLatex(0.2, 0.28, "anti-k_{T}, R=0.4 inclusive jets");
        ...
        c->Draw();
        c->Print("plots_an/mc_stat_unc_incl_"+observable+".png");
    }
}
