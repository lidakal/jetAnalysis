...
void model_unc(TString observable="rg")
{
    ...
    TString sample2 = "herwig_dijet_official_PF40";
    ...
    bottom_pad->Draw();
    c_unc->Draw();
    c_unc->Print("../plots_thesis/"+sample1+"_"+label+"_model_unc_"+observable+".pdf");

    // Save histograms 
    TString suffix_out = (is_inclusive) ? "inclusive" : "XXT";
    TString fout_name = "histos/" + observable + "_model_unc_" + suffix_out + ".root";
