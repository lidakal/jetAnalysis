...
void trk_inef_unc_inclusive(TString observable="rg")
{
     // Setup 
    ...
    TFile *fout = new TFile("./histos/"+observable+"_trk_inef_inclusive.root", "recreate");
    ...
    c_inef->Draw();
    c_inef->Print("plots_an/trk_inef_unc_incl_"+observable+".png");
    // fout->Close();
    // delete fout;
}