...
void draw_probabilities()
{
    ...
    // ---- Format the histos ----
    // dr
    format_probability(h_response_dr_bjet_aggrTMVA, "ln(R/#DeltaR)");
    format_probability(h_response_dr_bjet_aggrGenNoReco, "ln(R/#DeltaR)");

    // rg
    format_probability(h_response_rg_bjet_aggrTMVA);
    format_probability(h_response_rg_bjet_aggrGenNoReco);
    // format_probability(h_response_rg_bjet_aggrCuts_ip3dsig_2p5);

    // zg
    format_probability(h_response_zg_bjet_aggrTMVA, "z_{g}");
    format_probability(h_response_zg_bjet_aggrGenNoReco, "z_{g}");
    // format_probability(h_response_zg_bjet_aggrCuts_ip3dsig_2p5, "z_{g}");

    // mb
    format_probability(h_response_mb_bjet_aggrTMVA, "m_{pseudo-B}");
    // format_probability(h_response_mb_bjet_aggrCuts_ip3dsig_2p5, "m_{pseudo-B}");
    ...
    TString cname_dr_aggrTMVA = odir + label_aggrTMVA + suffix + "probability_dr.png";
    ...
    TString cname_dr_aggrGenNoReco = odir + label_aggrGenNoReco + suffix + "probability_dr.png";
