...
void compare_eff(TString observable="rg", TString jer_opt="nom", TString jec_opt="nom")
{  
    TString xlabel;
    ...
    TFile *fin_herwig = new TFile("histos/herwig_official_PF40_aggrTMVA_inclusive_histograms"+suffix+".root");

    TH2D *h_inclusive_herwig = (TH2D *) fin_herwig->Get("h_"+observable+"pt")->Clone("h_inclusive_herwig");
    TH2D *h_btag_herwig = (TH2D *) fin_herwig->Get("h_"+observable+"pt_tagged")->Clone("h_btag_herwig");
    TH2D *h_btag_withSF_herwig = (TH2D *) fin_herwig->Get("h_"+observable+"pt_tagged_withSF")->Clone("h_btag_withSF_herwig");

    TH2D *h_inclusive_gen_herwig = (TH2D *) fin_herwig->Get("h_"+observable+"pt_gen")->Clone("h_inclusive_gen_herwig");
    TH2D *h_btag_gen_herwig = (TH2D *) fin_herwig->Get("h_"+observable+"pt_gen_tagged")->Clone("h_btag_gen_herwig");
    TH2D *h_btag_withSF_gen_herwig = (TH2D *) fin_herwig->Get("h_"+observable+"pt_gen_tagged_withSF")->Clone("h_btag_withSF_gen_herwig");
    ...
    TH2D *h_eff_herwig = (TH2D *) h_btag_herwig->Clone("h_eff_herwig");
    h_eff_herwig->Divide(h_btag_herwig, h_inclusive_herwig, 1., 1., "b");

    TH2D *h_eff_withSF_herwig = (TH2D *) h_btag_withSF_herwig->Clone("h_eff_withSF_herwig");
    h_eff_withSF_herwig->Divide(h_btag_withSF_herwig, h_inclusive_herwig, 1., 1., "b");

    TH2D *h_eff_gen_herwig = (TH2D *) h_btag_gen_herwig->Clone("h_eff_gen_herwig");
    h_eff_gen_herwig->Divide(h_btag_gen_herwig, h_inclusive_gen_herwig, 1., 1., "b");

    TH2D *h_eff_withSF_gen_herwig = (TH2D *) h_btag_withSF_gen_herwig->Clone("h_eff_withSF_gen_herwig");
    h_eff_withSF_gen_herwig->Divide(h_btag_withSF_gen_herwig, h_inclusive_gen_herwig, 1., 1., "b");

    // Draw the efficiencies
    int ibin_pt = 3;
    double pt_min = h_eff_withSF_pythia->GetYaxis()->GetBinLowEdge(ibin_pt);
    double pt_max = h_eff_withSF_pythia->GetYaxis()->GetBinUpEdge(ibin_pt);
    ...
    TH1D *h_eff_herwig_1d = (TH1D *) h_eff_herwig->ProjectionX("h_eff_herwig_1d", ibin_pt, ibin_pt);
    h_eff_herwig_1d->SetMarkerStyle(kFullCross);
    h_eff_herwig_1d->SetMarkerColor(kBlue);
    h_eff_herwig_1d->SetLineColor(kBlue);
    h_eff_herwig_1d->SetMinimum(0.);
    h_eff_herwig_1d->SetMaximum(0.7);
    if (observable=="zpt") h_eff_herwig_1d->SetMaximum(1.);
    h_eff_herwig_1d->GetXaxis()->SetTitle(xlabel);
    h_eff_herwig_1d->GetYaxis()->SetTitle("b jet efficiency");
    h_eff_herwig_1d->SetTitle("herwig reco efficiency");

    TH1D *h_eff_withSF_herwig_1d = (TH1D *) h_eff_withSF_herwig->ProjectionX("h_eff_withSF_herwig_1d", ibin_pt, ibin_pt);
    h_eff_withSF_herwig_1d->SetMarkerStyle(kOpenCross);
    h_eff_withSF_herwig_1d->SetMarkerColor(kBlue);
    h_eff_withSF_herwig_1d->SetLineColor(kBlue);
    h_eff_withSF_herwig_1d->SetTitle("herwig reco efficiency with SF");

    TH1D *h_eff_gen_herwig_1d = (TH1D *) h_eff_gen_herwig->ProjectionX("h_eff_gen_herwig_1d", ibin_pt, ibin_pt);
    h_eff_gen_herwig_1d->SetMarkerStyle(kFullCross);
    h_eff_gen_herwig_1d->SetMarkerColor(kBlue);
    h_eff_gen_herwig_1d->SetLineColor(kBlue);
    h_eff_gen_herwig_1d->SetMinimum(0.);
    h_eff_gen_herwig_1d->GetXaxis()->SetTitle(xlabel);
    h_eff_gen_herwig_1d->GetYaxis()->SetTitle("b jet efficiency");
    h_eff_gen_herwig_1d->SetTitle("herwig gen efficiency");

    TH1D *h_eff_withSF_gen_herwig_1d = (TH1D *) h_eff_withSF_gen_herwig->ProjectionX("h_eff_withSF_gen_herwig_1d", ibin_pt, ibin_pt);
    h_eff_withSF_gen_herwig_1d->SetMarkerStyle(kOpenCross);
    h_eff_withSF_gen_herwig_1d->SetMarkerColor(kBlue);
    h_eff_withSF_gen_herwig_1d->SetLineColor(kBlue);
    h_eff_withSF_gen_herwig_1d->SetTitle("herwig gen efficiency with SF");

    TCanvas *c_eff = new TCanvas("c_eff", "", 800, 600);
    h_eff_pythia_1d->Draw("pe1");
    h_eff_withSF_pythia_1d->Draw("pe1 same");
    h_eff_herwig_1d->Draw("pe1 same");
    h_eff_withSF_herwig_1d->Draw("pe1 same");
    auto leg_eff = c_eff->BuildLegend();
    leg_eff->SetHeader(header);
    drawHeaderSimulation();
    c_eff->Draw();
    // c_eff->Print("plots_an/pythia_vs_herwig_btag_eff_"+observable+".png");

    TCanvas *c_eff_gen = new TCanvas("c_eff_gen", "", 800, 600);
    h_eff_gen_pythia_1d->Draw("pe1 same");
    h_eff_withSF_gen_pythia_1d->Draw("pe1 same");
    h_eff_gen_herwig_1d->Draw("pe1 same");
    h_eff_withSF_gen_herwig_1d->Draw("pe1 same");
    auto leg_eff_gen = c_eff_gen->BuildLegend();
    leg_eff_gen->SetHeader(header);
    drawHeaderSimulation();
    c_eff_gen->Draw();
    // c_eff_gen->Print("plots_an/pythia_vs_herwig_btag_eff_gen_"+observable+".png");
}