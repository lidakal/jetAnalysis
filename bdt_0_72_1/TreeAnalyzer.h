...
class TreeAnalyzer 
{
    public:
	    ...
	    Int_t           ipMatchStatus[200];
	    Float_t         ipPtMatch[200];
        Float_t         ipEtaMatch[200];
        Float_t         ipPhiMatch[200];
        Int_t           ipInSV[200];
        Float_t         ipSvtxdls[200];
        Float_t         ipSvtxdls2d[200];
        Float_t         ipSvtxm[200];
        Float_t         ipSvtxmcorr[200];
        ...
        // Constructors
        TreeAnalyzer();
        TreeAnalyzer(TString finName = "/data_CMS/cms/kalipoliti/chargedSJ_mergedSVtracks_gen_reco/merged_HiForestAOD.root", 
                     Bool_t init = true);
    	...
    	void SetBranchStatus(vector<TString> branchNames, Int_t status);
};

TreeAnalyzer::TreeAnalyzer(TString finName = "/data_CMS/cms/kalipoliti/chargedSJ_mergedSVtracks_gen_reco/merged_HiForestAOD.root", 
                           Bool_t init = true) 
{
...
void TreeAnalyzer::SetBranchStatus(TString branchName, Int_t status)
{
    t->SetBranchStatus(branchName, status);
}

void TreeAnalyzer::SetBranchStatus(vector<TString> branchNames, Int_t status)
{
