...
void prepare_data(TString finName = "/data_CMS/cms/kalipoliti/bJetMC/trackTaggingTraining/merged_HiForestAOD.root", 
                  TString foutName = "tmva_data_complex_bJetMC.root")
{
    TreeAnalyzer ta(finName, true);

    // Activate branches of interest

    std::vector<TString> activeBranches = {"nref", "jteta", "jtpt", "jtHadFlav", "jtNbHad", 
