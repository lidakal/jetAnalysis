...
void draw_disagreement_signal()
{
    ...
    TH1F *hdr_lowPU = (TH1F *)fin_lowPU->Get("hdr_signal");
    hdr_lowPU->SetName(TString(hdr_lowPU->GetName()) + "_lowPU");

    TH1F *hpt_lowPU = (TH1F *)fin_lowPU->Get("hpt_signal");
    ...
    TH1F *hdr_highPU = (TH1F *)fin_highPU->Get("hdr_signal");
    hdr_highPU->SetName(TString(hdr_highPU->GetName()) + "_highPU");

    TH1F *hpt_highPU = (TH1F *)fin_highPU->Get("hpt_signal");
   ...
   cdr->cd();
    ...
    cdr->Print(TString("./plots/combined_dr_disagreement_signal.png"));
    ...
    legdr_ratio->Draw();
    cdr_ratio->Draw();
    cdr_ratio->Print("./plots/combined_dr_ratio_disagreement_signal.png");
    ...
    cpt->Print(TString("./plots/combined_relpt_disagreement_signal.png"));
    ...
    line_pt->Draw();
    cpt_ratio->Draw();
    cpt_ratio->Print("./plots/combined_relpt_ratio_disagreement_signal.png");
}