...
void draw_track_gen_association_bjets()
{
    ...
    TH1F *hdrCut_lowPU = (TH1F *)fin_lowPU->Get("hdrCut_bjets");
    ...
    TH1F *hptCut_lowPU = (TH1F *)fin_lowPU->Get("hptCut_bjets");
    ...
    TH1F *hdrCut_highPU = (TH1F *)fin_highPU->Get("hdrCut_bjets");
    ...
    TH1F *hptCut_highPU = (TH1F *)fin_highPU->Get("hptCut_bjets");
    ...
    cdr->Print(TString("./plots/combined_dr_bjets.png"));
    ...
    legdr_ratio->Draw();
    cdr_ratio->Draw();
    cdr_ratio->Print("./plots/combined_dr_ratio_bjets.png");
    ...
    cpt->Print(TString("./plots/combined_relpt_bjets.png"));
    ...
    line_pt->Draw();
    cpt_ratio->Draw();
    cpt_ratio->Print("./plots/combined_relpt_ratio_bjets.png");
}