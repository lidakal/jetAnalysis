...
void draw_disagreement()
{
   ...
   cdr->cd();
    ...
    cdr->Print(TString("./plots/combined_dr_disagreement.png"));
    ...
    legdr_ratio->Draw();
    cdr_ratio->Draw();
    cdr_ratio->Print("./plots/combined_dr_ratio_disagreement.png");
    ...
    cpt->Print(TString("./plots/combined_relpt_disagreement.png"));
    ...
    line_pt->Draw();
    cpt_ratio->Draw();
    cpt_ratio->Print("./plots/combined_relpt_ratio_disagreement.png");
}